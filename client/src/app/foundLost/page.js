...
const page = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.found_near.trim()) newErrors.found_near = 'found location is required';
  ...
  console.log(key, value);
    ...
    await axios.post('/api/foundItem', data, {
      headers: {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    value={formData.found_near}
                    onChange={(e) => handleInputChange('found_near', e.target.value)}
